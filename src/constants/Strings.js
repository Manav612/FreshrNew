...
export const AppUrl =
  Platform.OS == 'ios'
    ? 'https://apps.apple.com/in/app/digital-health-news/id6473037148'
    : 'https://play.google.com/store/apps/details?id=com.dhn';
...
export const NavigationScreens = {
  ...
  ScheduleCalenderScreen: 'ScheduleCalenderScreen',
...
export const label = {
  Exclusive: 'Exclusive',
  HeaderDesc:
    'E-Pharmacy MrMed Secures $500,000 Funding from Tamil Nadu Emerging Sector Seed Fund',
...
export const TopPopular = ["Today's Top Stories", 'Popular Stories'];
...
export const Details = {
  ...
  highlight:
    '“This journey will facilitate technology demonstrations, reaching over 1800 healthcare professionals from 200 hospitals and showcasing the transformative solutions offered by Zimmer Biomet.”',
};

export const EliteText = {
  text: 'Unlock Your Access to',
  text2:
    'Dive deeper into the world of health and wellness with "DHN PLUS," your exclusive gateway to in-depth articles, expert opinions, and special features.',
  text3:
    'Join "DHN PLUS" now to unlock a universe of premium health stories. Upgrade your health literacy today!',
};
