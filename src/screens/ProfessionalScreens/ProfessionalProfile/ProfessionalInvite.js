...
import { barber, BothOrange, BothWhite, ComeToYouOrange, ComeToYouWhite, femaleOrange, femaleWhite, Filter, FilterBlack, FilterWhite, HomeIcon2, HouseOrange, InSalonOrange, InSalonWhite, maleOrange, maleWhite, ShareIcon, ShareIcon2, ShareIcon3 } from '../../../constants/Icons';
    ...
    return (
        <>
            <View style={{ width: Screen_Width, paddingHorizontal: 15, position: 'absolute', top: Screen_Height * 0.01, zIndex: 100 }}>
                <View style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: COLOR.WHITE, marginHorizontal: 2, marginVertical: 10, marginBottom: 5, padding: 10, elevation: 2, shadowColor: COLOR.ChartBlue, borderRadius: 15 }}>
                    <Text style={{ color: COLOR.BLACK, fontWeight: '800', fontSize: 14 }}>Delivery Options Links</Text>
                    <View style={{ flexDirection: 'row', alignSelf: 'center', gap: 30, marginVertical: 5 }}>
                        <TouchableOpacity style={{ width: Screen_Width * 0.35, flexDirection: 'row', gap: 5, height: 30, backgroundColor: activeTab === 'Delivery' ? COLOR.ORANGECOLOR : COLOR.GULABI, borderRadius: 30, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: COLOR.ORANGECOLOR }} onPress={() => { setActiveTab('Delivery') }}>
                            ...
                            <Text style={{ color: activeTab === 'Delivery' && COLOR ? COLOR.WHITE : COLOR.ORANGECOLOR, fontWeight: '600', fontSize: 12 }}>Delivery links</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ width: Screen_Width * 0.35, flexDirection: 'row', gap: 10, height: 30, backgroundColor: activeTab === 'Salon' ? COLOR.ORANGECOLOR : COLOR.GULABI, borderRadius: 30, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: COLOR.ORANGECOLOR }} onPress={() => { setActiveTab('Salon') }}>
                            ...
                            <Text style={{ color: activeTab === 'Salon' ? COLOR.WHITE : COLOR.ORANGECOLOR, fontWeight: '600', fontSize: 12 }}>Facility links</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 10 }}>
                    ...
                    >
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
                            <Text style={{ textAlign: 'center', fontSize: 16, color: COLOR.BLACK }}>
                    ...
                    <TouchableOpacity onPress={openBottomSheet2} style={{ height: 40, justifyContent: 'center', alignItems: 'center', borderRadius: 10, backgroundColor: COLOR.WHITE, flexDirection: 'row', gap: 5, paddingHorizontal: 5 }}>
                        <FastImage source={theme == 1 ? ShareIcon3 : ShareIcon} style={{ height: 20, width: 20 }} />
                        <Text style={{ color: COLOR.BLACK }}>Share</Text>
                    </TouchableOpacity>
                </View>
            </View>
