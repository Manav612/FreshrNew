...
import { Commissionsplits } from '../../../components/utils';
import { Hair1 } from '../../../constants/Icons';
import { Screen_Width } from '../../../constants/Constants';

const FacilityCommissionsplits = () => {
        ...
        <ScrollView style={{ width: Screen_Width, height: Screen_Height, paddingHorizontal: 15,backgroundColor:COLOR.WHITE}}>
            <View style={styles.HeaderView}>
                <View style={{ justifyContent: 'center', alignItems: 'center', gap: 10, flexDirection: 'row' }}>
                    ...
                    <Text style={{ fontSize: 24, color: COLOR.BLACK }}>Commission Splits</Text>
                </View>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    >
                        ...
                        <View style={{backgroundColor:'#CECECE',width:60,height:30,justifyContent:'center',alignItems:'center',borderRadius:10}}>
...
export default FacilityCommissionsplits
