  ...
  return (
    ...
    <View style={{ justifyContent: 'center', alignItems: 'center', width: Screen_Width,height:600 }}>
        <GooglePlacesAutocomplete
          ...
          <TouchableOpacity style={{ width: Screen_Width * 0.9,justifyContent: 'center', alignItems: 'center', height: 50, backgroundColor: COLOR.ORANGECOLOR, marginVertical: 10, borderRadius: 15 }}><Text style={{ color: COLOR.WHITE, fontWeight: 'bold' }}>Save Address</Text></TouchableOpacity>
        </View>
        </>
  )
}
