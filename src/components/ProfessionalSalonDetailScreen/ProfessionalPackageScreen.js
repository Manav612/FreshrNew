...
const ProfessionalPackageScreen = () => {
    ...
    <View style={{
      ...
      <View style={{ flexDirection: 'column', marginLeft: 15, gap: 5 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: Screen_Width * 0.55, alignItems: 'center' }}>
          ...
          <TouchableOpacity style={{ width: Screen_Width * 0.20, height: Screen_Height * 0.04, backgroundColor: COLOR.ORANGECOLOR, justifyContent: 'center', borderRadius: 35, alignSelf: 'center' }} onPress={()=>navigation.navigate('BookAppointment Screen')}>
...
export default ProfessionalPackageScreen
