...
const OrderProcessingScreenProfSide = ({ route }) => {
  ...
  return (
    <View style={{ height: Screen_Height, width: Screen_Width, paddingHorizontal: 15, alignItems: 'center', justifyContent: 'center' }}>
      <View style={{ width: Screen_Width * 0.9, justifyContent: 'center', alignItems: 'center', backgroundColor: COLOR.WHITE, shadowColor: COLOR.BLACK_70, elevation: 2, borderRadius: 15 }}>
        ...
        />
        <View style={{ height: Screen_Height * 0.17, marginBottom: 10, }}>
          <FlatList
            data={services}
